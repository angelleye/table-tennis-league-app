...
<div class="container">
    <div class="row">
        ...
        if ($count <= 0) {
            echo "<div class='alert alert-danger' role='alert'>No Records Found For Event Date " . $_POST['edate'] . "</div>";
            echo "</div></div>";
            exit;
        }
        ...
        <form class="form-inline pull-right">
            <div class="form-group">
                <label for="email">Event Date : <?php echo $_POST['edate']; ?></label>
                <a class="btn btn-primary" id="editLink" href="editEvent.php?id=<?php echo $event_id; ?>">Edit</a>
            </div>
        </form>
